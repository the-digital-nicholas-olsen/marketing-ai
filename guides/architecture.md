...
|---|---|
| Contact, page, form and workflow state | HubSpot |
| Opportunity and Salesforce campaign state | Salesforce |
| Event schedules, KOL engagements and operational status | Smartsheet, after schema and access validation |
| Settled payments | Finance |
| Transcripts, meeting summaries, completed outputs and originals | Approved document/asset library |
| Reusable marketing methods | This repository and reviewed upstream dependencies |

The event manager maintains logistics in Smartsheet; marketing operations maintains schemas and retrieval methods. AI retrieves only the relevant records at runtime. Public Git may describe field meanings generically but must not contain actual engagements, payment records or meeting histories.
