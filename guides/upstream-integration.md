...
The design system and lumenis-ai remain separately maintained. The image library has been adopted into assets/image-library; its provenance records the source revision and local adjustments. Do not copy their entire libraries here or silently replace local approved rules. Compare scope, provenance, licensing and dependencies, then test both clients and the affected divisions. Submit focused public-safe upstream improvements through PRs. The image-library adoption is the scoped exception; no upstream repository was modified.
