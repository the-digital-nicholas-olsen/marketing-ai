...
| [lumenis-design-system](https://github.com/laarnicayetano/lumenis-design-system) | Original source of the OptiLIFT and OptiLIGHT imports; its corporate baseline is superseded here by Lumenis Corporate |
...
The upstream design system and lumenis-ai remain separately maintained. assets/design-system now holds three standalone brand systems: Lumenis Corporate (a Claude Design export of the 2026 brandbook), OptiLIGHT and OptiLIFT. The OptiLIGHT and OptiLIFT folders began as scoped upstream imports and were made standalone on 2026-09-14; the upstream corporate baseline was retired in favour of Lumenis Corporate. Optional runnable upstream UI kits remain upstream. The image library has been adopted into assets/image-library; its provenance records the source revision and local adjustments. Do not copy their entire libraries here or silently replace local approved rules. Compare scope, provenance, licensing and dependencies, then test both clients and the affected divisions. Submit focused public-safe upstream improvements through PRs. The image-library adoption is the scoped exception; no upstream repository was modified.
